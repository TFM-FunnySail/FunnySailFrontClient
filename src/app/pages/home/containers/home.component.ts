...
export class HomeComponent implements OnInit {
  ...
  constructor(private router: Router,
    ...
    this.registerForm = this.formBuilder.group({
      ...
      identification: ['', [Validators.required, Validators.pattern('^[0-9][A-Z]{10}$')]],
      paymentMethod: ['', []],
  ...
  SubmitNewUser(){
    ...
    console.log("birthDate: " + this.registerForm.get('birthDate')?.value);
    console.log("phone: " + this.registerForm.get('phone')?.value);
    console.log("id: " + this.registerForm.get('id')?.value);
    console.log("address: " + this.registerForm.get('address')?.value);
    console.log("city: " + this.registerForm.get('city')?.value);
    console.log("state: " + this.registerForm.get('state')?.value);
    console.log("country: " + this.registerForm.get('country')?.value);
    console.log("zip: " + this.registerForm.get('zip')?.value);
    console.log("cardNumber: " + this.registerForm.get('cardNumber')?.value);
